 ...
 *************************/
const BELIEF_LIST = [
  "من توانایی تغییر باورهای محدودکننده‌ام را دارم.",
  "گذشته‌ام هویت امروز مرا محدود نمی‌کند.",
  "من شایسته رشد، موفقیت و آرامش هستم.",
  "اشتباهاتم بخشی از مسیر یادگیری من هستند.",
  "من می‌توانم متفاوت فکر کنم و متفاوت عمل کنم.",
  "باورهایم قابل بازنویسی هستند.",
  "من کنترل واکنش‌هایم را در دست دارم.",
  "هر روز آگاه‌تر از دیروز می‌شوم.",
  "من قدرت انتخاب دارم.",
  "من می‌توانم نسخه بهتری از خودم بسازم."
];
